...
namespace Networking
{
    public class NetworkPlayer : NetworkBehaviour
    {
        ...
        {
            if (cachedMaterial == null) cachedMaterial = gameObject.GetComponent<MeshRenderer>().material;
        ...
        public override void OnStartLocalPlayer()
        {
            ...
            // creates a display showing player is present in the lobby
            //GameObject playerDisplayInstance = Instantiate(playerDisplay);
            //NetworkServer.Spawn(playerDisplayInstance);
        }
        ...
        public override void OnStartServer()
        {
            ...
            for(int i = 0; i < 10; i++) syncedFloats.Add(Random.Range(0, 11));
        }
